...
import com.Agile.Quiz.models.ModelFeedback;
 ...
 * @author jamesread
 */
@WebServlet(name = "QuizFeedback", urlPatterns = {"/QuizFeedback"})
public class QuizFeedback extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String quizName = "test"; // TODO = request.getParameter("quizName");
